...
export const stories = [
  {
    id: "s1",
    bride: "Meera & Rohan",
    event: "Destination Royal Wedding in Udaipur",
...
export const faqs = [
  {
    ...
    answer: "It is highly recommended to book 6 to 8 months in advance, especially during peak wedding seasons (November to February), as dates fill up quickly."
  },
  {
    id: "f2",
    question: "Do you offer makeup trials?",
    answer: "Yes, we offer paid makeup and hair trials at our studio. If you proceed with the booking, a percentage of the trial fee is adjusted against your final package."
  },
  {
    id: "f3",
    question: "Do you travel to the venue for makeup?",
    answer: "Yes, we provide both studio services and on-location services at your home or wedding venue. Travel charges are applicable based on the distance."
  },
  {
    id: "f4",
    question: "Are hair extensions and accessories included?",
    answer: "Basic hair padding is included. Premium hair extensions can be provided on a rental basis or you can bring your own. Floral accessories need to be arranged by the client, though we provide the styling and securing."
  },
  {
    id: "f5",
    question: "What brands of products do you use?",
    answer: "We strictly use premium, international luxury brands like Charlotte Tilbury, MAC, NARS, Huda Beauty, Estée Lauder, and Bobbi Brown to ensure skin safety and long-lasting wear."
  }
];
